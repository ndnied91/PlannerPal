...
//   return (
//     <section>
//       <div className="fixed left-0 top-0 flex text-center w-screen h-screen justify-center items-center">
//         <OutsideClickHandler onOutsideClick={() => setShowCalModal(false)}>
//           <form
//             onSubmit={handleSubmit}
//             onKeyDown={(event) => {
//               event.keyCode === 13 ? handleSubmit(event) : null;
//             }}
//             className="w-screen md:w-[38rem] h-fit bg-white shadow-2xl"
//           >
...
const SingleItemOverview = ({ selectedEvent, setShowCalModal }) => {
  const { daySelected } = useContext(GlobalContext);
